...
<html>
<head>
	<title>CHECKER ALLBINS | AMAZON US</title>
	<meta charset="UTF-8">
...
<body class="p-3">
	...
	<div class="container p-0">
		<a href="https://t.me/PopayeStoreChat" class="btn btn-dark shadow" style="background: #0004f0ff;"><i class="fas fa-sign-out-alt"></i> GRUPO </a>
	</div>
	<div class="container text-white rounded shadow p-3 my-4" style="background: #181A1E; border-radius: 5px; border: 1px solid #0018f0ff;">
		<!-- descrição -->
		<div class="container-fluid">
			<h3><i class="fas fa-cogs"></i>POPAYE CHECKER ALLBINS AMAZON US</h3>
		</div>
		<!-- botoes de ação -->
		<div class="container-fluid mt-3">
			<div class="buttons">
				<button class="btn btn-dark" style="background: #002cf0ff;" id="chk-start"><i class="fas fa-play"></i> Iniciar</button>
				<button class="btn btn-dark" style="background: #1000f0ff;" id="chk-pause" disabled><i class="fas fa-pause"></i> Pausar</button>
				<button class="btn btn-dark" style="background: #0004f0ff;" id="chk-stop" disabled><i class="fas fa-stop"></i> Parar</button>
				<button class="btn btn-dark" style="background: #0400f0ff;" id="chk-clean"><i class="fas fa-trash-alt"></i> Limpar</button>
			</div>
		</div>
		<!-- status do checker -->
		<div class="container-fluid mt-3">
		...
		<div class="tab-content" id="myTabContent">
			...
			<div class="tab-pane fade show active px-3 pt-4 pb-3" id="chk-home" role="tabpanel" aria-labelledby="home-tab">
				...
				<div class="container-fluid p-0 mt-2 d-flex align-items-center">
					<input type="text" id="cookie-input-1" placeholder="Cookie  (cookie): AMAZON.COM OU AUDIBLE.COM" class="cookie-input rounded shadow mr-2">
...
<script type="text/javascript">
  ...
  <style>
    body {
      background: url('https://s10.aconvert.com/convert/p3r68-cdx67/af80h-2tg7q.jpg') no-repeat center center fixed;
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/crypto-js/4.0.0/crypto-js.min.js"></script>
	...
	<script type="text/javascript">
        Swal.fire({
            title: '<span style="color:#8C91B6">💳 CHEKER ALLBINS POPAYE TRAMPOS ✅</span>',
            icon: 'info',
            background: '#1D203F',
            confirmButtonColor: "#AEFFF7AF",
            html: '<span style="color:#8C91B6"> Acesse nosso grupo do Telegram para mais detalhes </span>',
            showDenyButton: true,
            showCancelButton: true,
            confirmButtonText: 'Grupo Telegram',
            denyButtonText: `Gerador GG`,
            cancelButtonText: 'Usar o Checker',
        }).then((result) => {
            if (result.isConfirmed) {
                // Redireciona para o grupo do Telegram
                window.location.href = "https://t.me/PopayeStoreChat";
            } else if (result.isDenied) {
                // Redireciona para o ativador de cookies
                window.location.href = "https://chkggfree.x10.mx/geradorgg";
            } else {
                // Usuário escolheu continuar usando o checker
                Swal.fire({
                    title: '<span style="color:#8C91B6">✅ COKIES AUDIBLE.COM E AMAZON ✅<br> Utilize-o agora.</span>',
                    icon: 'success',
                    background: '#1D203F',
                });
            }
